            ...
            if(size > 0.2){
                for (int i = 0; i<4;i++){
                    ...
                    ProjectileDeflection deflection1 = (a,b,c)->{
                        ...
                        a.addDeltaMovement(new Vec3(c.nextInt(-100,100)*0.001d,c.nextInt(-100,100)*0.001d, c.nextInt(-100,100)*0.001d));
                    };

                    deflection1.deflect(entity1,entity, RandomSource.createNewThreadLocalInstance());
                }
            }
            this.kill();
        }
