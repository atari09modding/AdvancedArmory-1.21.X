...
public class ModItems {
    ...
    public static final DeferredItem<Item> SHULKER_ARROW = ITEMS.register("shulker_arrow",
            ()->new CustomArrow<ShulkerArrow>(new Item.Properties(), ModEntities.SHULKER_ARROW));
