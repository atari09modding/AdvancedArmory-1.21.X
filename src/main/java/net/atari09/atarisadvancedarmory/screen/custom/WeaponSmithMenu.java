...
public class WeaponSmithMenu extends AbstractContainerMenu {
    public final WeaponSmithBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public WeaponSmithMenu(int containerId, Inventory inv, FriendlyByteBuf extraData){
        this(containerId,inv,inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }


    public WeaponSmithMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.WEAPONSMITH_MENU.get(), containerId);
        this.blockEntity = ((WeaponSmithBlockEntity) entity);
